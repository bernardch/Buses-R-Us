    ...
    public void plotBuses() {
        ...
        if (selectedStop != null) {
            for (Bus bus : selectedStop.getBuses()) {
                GeoPoint busLocn = Geometry.gpFromLL(bus.getLatLon());
                OverlayItem busItem = new OverlayItem(bus.getRoute().getNumber(), bus.getDestination(), busLocn);
                busLocationsOverlay.addItem(busItem);
            }
        }
    }
